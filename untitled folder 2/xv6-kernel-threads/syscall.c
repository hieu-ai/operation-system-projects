...
extern int sys_kthread_create(void); //MARCHANT added
extern int sys_kthread_id(void); //MARCHANT added
extern int sys_kthread_exit(void); //MARCHANT added
extern int sys_kthread_join(void); //MARCHANT added
extern int sys_kthread_mutex_alloc(void); // HN
extern int sys_kthread_mutex_dealloc(void); // HN
extern int sys_kthread_mutex_lock(void); // HN
extern int sys_kthread_mutex_unlock(void); // HN
