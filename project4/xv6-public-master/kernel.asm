...
80101ec8:	68 a2 79 10 80       	push   $0x801079a2
...
80102322:	81 fb 00 35 12 80    	cmp    $0x80123500,%ebx
...
80102eb7:	68 00 35 12 80       	push   $0x80123500
...
80103674:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103677:	c7 40 14 2a 57 10 80 	movl   $0x8010572a,0x14(%eax)
  p->context = (struct context*)sp;
...
801037ad:	68 84 78 10 80       	push   $0x80107884
...
801039b8:	e8 a3 35 00 00       	call   80106f60 <cow>
...
80104028:	0f 84 fc 00 00 00    	je     8010412a <procdump+0x11a>
      continue;
...
8010406e:	68 03 7c 10 80       	push   $0x80107c03
...
80104081:	89 45 b0             	mov    %eax,-0x50(%ebp)
80104084:	05 00 10 00 00       	add    $0x1000,%eax
80104089:	89 45 ac             	mov    %eax,-0x54(%ebp)
8010408c:	eb 12                	jmp    801040a0 <procdump+0x90>
8010408e:	66 90                	xchg   %ax,%ax
80104090:	83 45 b0 04          	addl   $0x4,-0x50(%ebp)
80104094:	8b 45 b0             	mov    -0x50(%ebp),%eax

  //MARCHANT ADDED
   pde_t *pde = p->pgdir; // first level
    for(int i = 0; i < NPTENTRIES; i++){
80104097:	3b 45 ac             	cmp    -0x54(%ebp),%eax
8010409a:	0f 84 8a 00 00 00    	je     8010412a <procdump+0x11a>
      if(pde[i] & PTE_P){
801040a0:	8b 45 b0             	mov    -0x50(%ebp),%eax
801040a3:	8b 08                	mov    (%eax),%ecx
801040a5:	f6 c1 01             	test   $0x1,%cl
801040a8:	74 e6                	je     80104090 <procdump+0x80>
        pte_t *pt = (pde_t*)P2V(PTE_ADDR(pde[i])); // second level
801040aa:	81 e1 00 f0 ff ff    	and    $0xfffff000,%ecx
        for(int j = 0; j < NPTENTRIES; j++){
801040b0:	31 db                	xor    %ebx,%ebx
        pte_t *pt = (pde_t*)P2V(PTE_ADDR(pde[i])); // second level
801040b2:	8d b1 00 00 00 80    	lea    -0x80000000(%ecx),%esi
        for(int j = 0; j < NPTENTRIES; j++){
801040b8:	89 f7                	mov    %esi,%edi
801040ba:	eb 0f                	jmp    801040cb <procdump+0xbb>
801040bc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
801040c0:	83 c3 01             	add    $0x1,%ebx
801040c3:	81 fb 00 04 00 00    	cmp    $0x400,%ebx
801040c9:	74 c5                	je     80104090 <procdump+0x80>
801040cb:	8d 34 9f             	lea    (%edi,%ebx,4),%esi
        //if(present and use)
          if(pt[j] &PTE_P && pt[j] &PTE_U){
801040ce:	8b 06                	mov    (%esi),%eax
801040d0:	89 c2                	mov    %eax,%edx
801040d2:	83 e2 05             	and    $0x5,%edx
801040d5:	83 fa 05             	cmp    $0x5,%edx
801040d8:	75 e6                	jne    801040c0 <procdump+0xb0>
            uint pa = (pt[j] >> 12);
            cprintf("%d->%d, ", j, pa);
...
801040e2:	68 4d 78 10 80       	push   $0x8010784d
801040e7:	89 45 b4             	mov    %eax,-0x4c(%ebp)
801040ea:	e8 71 c5 ff ff       	call   80100660 <cprintf>
            if(pt[j] & PTE_W){
801040ef:	83 c4 10             	add    $0x10,%esp
801040f2:	f6 06 02             	testb  $0x2,(%esi)
801040f5:	8b 45 b4             	mov    -0x4c(%ebp),%eax
801040f8:	75 1e                	jne    80104118 <procdump+0x108>
              cprintf("y\n");
            }
            else if(counter[pa] == 1){
801040fa:	80 b8 00 55 11 80 01 	cmpb   $0x1,-0x7feeab00(%eax)
80104101:	74 15                	je     80104118 <procdump+0x108>
              cprintf("y\n");
            }
            else{
              cprintf("n\n");
80104103:	83 ec 0c             	sub    $0xc,%esp
80104106:	68 56 78 10 80       	push   $0x80107856
8010410b:	e8 50 c5 ff ff       	call   80100660 <cprintf>
80104110:	83 c4 10             	add    $0x10,%esp
80104113:	eb ab                	jmp    801040c0 <procdump+0xb0>
80104115:	8d 76 00             	lea    0x0(%esi),%esi
              cprintf("y\n");
80104118:	83 ec 0c             	sub    $0xc,%esp
8010411b:	68 e6 7b 10 80       	push   $0x80107be6
80104120:	e8 3b c5 ff ff       	call   80100660 <cprintf>
80104125:	83 c4 10             	add    $0x10,%esp
80104128:	eb 96                	jmp    801040c0 <procdump+0xb0>
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010412a:	83 45 a8 7c          	addl   $0x7c,-0x58(%ebp)
8010412e:	8b 45 a8             	mov    -0x58(%ebp),%eax
80104131:	3d 54 4c 11 80       	cmp    $0x80114c54,%eax
80104136:	0f 82 e4 fe ff ff    	jb     80104020 <procdump+0x10>
      }
...
8010414a:	8d 5d c0             	lea    -0x40(%ebp),%ebx
8010414d:	50                   	push   %eax
8010414e:	8b 45 a8             	mov    -0x58(%ebp),%eax
80104151:	8b 40 1c             	mov    0x1c(%eax),%eax
...
80104163:	eb 22                	jmp    80104187 <procdump+0x177>
80104165:	8d 76 00             	lea    0x0(%esi),%esi
        cprintf(" %p", pc[i]);
80104168:	83 ec 08             	sub    $0x8,%esp
8010416b:	83 c3 04             	add    $0x4,%ebx
8010416e:	50                   	push   %eax
8010416f:	68 81 72 10 80       	push   $0x80107281
80104174:	e8 e7 c4 ff ff       	call   80100660 <cprintf>
      for(i=0; i<10 && pc[i] != 0; i++)
80104179:	8d 45 e8             	lea    -0x18(%ebp),%eax
8010417c:	83 c4 10             	add    $0x10,%esp
8010417f:	39 c3                	cmp    %eax,%ebx
80104181:	0f 84 e4 fe ff ff    	je     8010406b <procdump+0x5b>
80104187:	8b 03                	mov    (%ebx),%eax
80104189:	85 c0                	test   %eax,%eax
8010418b:	75 db                	jne    80104168 <procdump+0x158>
8010418d:	e9 d9 fe ff ff       	jmp    8010406b <procdump+0x5b>
...
801041aa:	68 c4 78 10 80       	push   $0x801078c4
...
801043c5:	68 cf 78 10 80       	push   $0x801078cf
801043ca:	e8 c1 bf ff ff       	call   80100390 <panic>
    panic("popcli");
801043cf:	83 ec 0c             	sub    $0xc,%esp
801043d2:	68 e6 78 10 80       	push   $0x801078e6
...
801044b7:	68 ed 78 10 80       	push   $0x801078ed
...
8010450c:	68 f5 78 10 80       	push   $0x801078f5
...
80104910 <syscall>:
[SYS_procdump] sys_procdump, // HN added
};
...
80104950:	68 fd 78 10 80       	push   $0x801078fd
...
80104aa4:	68 98 79 10 80       	push   $0x80107998
...
80104abc:	68 97 79 10 80       	push   $0x80107997
...
80104ad5:	68 8b 79 10 80       	push   $0x8010798b
...
80104aea:	68 9a 79 10 80       	push   $0x8010799a
80104aef:	e8 9c b8 ff ff       	call   80100390 <panic>
    panic("create: ialloc");
80104af4:	83 ec 0c             	sub    $0xc,%esp
80104af7:	68 7c 79 10 80       	push   $0x8010797c
...
80104ee9:	58                   	pop    %eax
80104eea:	5a                   	pop    %edx
80104eeb:	68 98 79 10 80       	push   $0x80107998
...
80104f04:	68 97 79 10 80       	push   $0x80107997
...
80105703:	83 ec 08             	sub    $0x8,%esp
  procdump();
80105706:	e8 05 e9 ff ff       	call   80104010 <procdump>
  return 1;
8010570b:	b8 01 00 00 00       	mov    $0x1,%eax
80105710:	c9                   	leave  
80105711:	c3                   	ret    
...
80105713:	06                   	push   %es
  pushl %fs
80105714:	0f a0                	push   %fs
  pushl %gs
80105716:	0f a8                	push   %gs
  pushal
80105718:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
80105719:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
8010571d:	8e d8                	mov    %eax,%ds
  movw %ax, %es
8010571f:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
80105721:	54                   	push   %esp
  call trap
80105722:	e8 c9 00 00 00       	call   801057f0 <trap>
  addl $4, %esp
80105727:	83 c4 04             	add    $0x4,%esp
...
8010572a:	61                   	popa   
  popl %gs
8010572b:	0f a9                	pop    %gs
  popl %fs
8010572d:	0f a1                	pop    %fs
  popl %es
8010572f:	07                   	pop    %es
  popl %ds
80105730:	1f                   	pop    %ds
...
8010578e:	00 00 ef 
  initlock(&tickslock, "time");
80105791:	68 dd 79 10 80       	push   $0x801079dd
...
801057a4:	66 a3 a6 4e 11 80    	mov    %ax,0x80114ea6
  initlock(&tickslock, "time");
801057aa:	e8 21 eb ff ff       	call   801042d0 <initlock>
}
...
80105810:	ff 24 85 84 7a 10 80 	jmp    *-0x7fef857c(,%eax,4)
...
8010582a:	0f 84 04 02 00 00    	je     80105a34 <trap+0x244>
80105830:	f6 47 3c 03          	testb  $0x3,0x3c(%edi)
80105834:	0f 84 fa 01 00 00    	je     80105a34 <trap+0x244>
...
80105875:	68 40 7a 10 80       	push   $0x80107a40
...
80105897:	74 1d                	je     801058b6 <trap+0xc6>
80105899:	e8 42 df ff ff       	call   801037e0 <myproc>
8010589e:	8b 50 24             	mov    0x24(%eax),%edx
801058a1:	85 d2                	test   %edx,%edx
801058a3:	74 11                	je     801058b6 <trap+0xc6>
801058a5:	0f b7 47 3c          	movzwl 0x3c(%edi),%eax
801058a9:	83 e0 03             	and    $0x3,%eax
801058ac:	66 83 f8 03          	cmp    $0x3,%ax
801058b0:	0f 84 3a 01 00 00    	je     801059f0 <trap+0x200>
    exit();

  // Force process to give up CPU on clock tick.
  // If interrupts were on while locks held, would need to check nlock.
  if(myproc() && myproc()->state == RUNNING &&
801058b6:	e8 25 df ff ff       	call   801037e0 <myproc>
801058bb:	85 c0                	test   %eax,%eax
801058bd:	74 0b                	je     801058ca <trap+0xda>
801058bf:	e8 1c df ff ff       	call   801037e0 <myproc>
801058c4:	83 78 0c 04          	cmpl   $0x4,0xc(%eax)
801058c8:	74 66                	je     80105930 <trap+0x140>
...
801058d1:	74 19                	je     801058ec <trap+0xfc>
801058d3:	e8 08 df ff ff       	call   801037e0 <myproc>
801058d8:	8b 40 24             	mov    0x24(%eax),%eax
801058db:	85 c0                	test   %eax,%eax
801058dd:	74 0d                	je     801058ec <trap+0xfc>
801058df:	0f b7 47 3c          	movzwl 0x3c(%edi),%eax
801058e3:	83 e0 03             	and    $0x3,%eax
801058e6:	66 83 f8 03          	cmp    $0x3,%ax
801058ea:	74 35                	je     80105921 <trap+0x131>
    exit();
}
...
80105934:	75 94                	jne    801058ca <trap+0xda>
    yield();
80105936:	e8 f5 e3 ff ff       	call   80103d30 <yield>
8010593b:	eb 8d                	jmp    801058ca <trap+0xda>
8010593d:	8d 76 00             	lea    0x0(%esi),%esi
    pagefault();
80105940:	e8 fb 17 00 00       	call   80107140 <pagefault>
    break;
80105945:	e9 46 ff ff ff       	jmp    80105890 <trap+0xa0>
8010594a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    if(cpuid() == 0){
80105950:	e8 6b de ff ff       	call   801037c0 <cpuid>
80105955:	85 c0                	test   %eax,%eax
80105957:	0f 84 a3 00 00 00    	je     80105a00 <trap+0x210>
    lapiceoi();
8010595d:	e8 ee cd ff ff       	call   80102750 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105962:	e8 79 de ff ff       	call   801037e0 <myproc>
80105967:	85 c0                	test   %eax,%eax
80105969:	0f 85 2a ff ff ff    	jne    80105899 <trap+0xa9>
8010596f:	e9 42 ff ff ff       	jmp    801058b6 <trap+0xc6>
...
8010597d:	e8 ce cd ff ff       	call   80102750 <lapiceoi>
    break;
80105982:	e9 09 ff ff ff       	jmp    80105890 <trap+0xa0>
80105987:	89 f6                	mov    %esi,%esi
80105989:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
    uartintr();
80105990:	e8 3b 02 00 00       	call   80105bd0 <uartintr>
    lapiceoi();
80105995:	e8 b6 cd ff ff       	call   80102750 <lapiceoi>
    break;
8010599a:	e9 f1 fe ff ff       	jmp    80105890 <trap+0xa0>
8010599f:	90                   	nop
...
801059af:	68 e8 79 10 80       	push   $0x801079e8
801059b4:	e8 a7 ac ff ff       	call   80100660 <cprintf>
    lapiceoi();
801059b9:	e8 92 cd ff ff       	call   80102750 <lapiceoi>
    break;
801059be:	83 c4 10             	add    $0x10,%esp
801059c1:	e9 ca fe ff ff       	jmp    80105890 <trap+0xa0>
...
80105a2f:	e9 29 ff ff ff       	jmp    8010595d <trap+0x16d>
...
80105a45:	68 0c 7a 10 80       	push   $0x80107a0c
80105a4a:	e8 11 ac ff ff       	call   80100660 <cprintf>
      panic("trap");
80105a4f:	83 c4 14             	add    $0x14,%esp
80105a52:	68 e2 79 10 80       	push   $0x801079e2
...
80105b4c:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105b4f:	bb 4c 7b 10 80       	mov    $0x80107b4c,%ebx
  ioapicenable(IRQ_COM1, 0);
...
80105be7:	6a 00                	push   $0x0
  jmp alltraps
80105be9:	e9 24 fb ff ff       	jmp    80105712 <alltraps>
...
80105bf0:	6a 01                	push   $0x1
  jmp alltraps
80105bf2:	e9 1b fb ff ff       	jmp    80105712 <alltraps>
...
80105bf9:	6a 02                	push   $0x2
  jmp alltraps
80105bfb:	e9 12 fb ff ff       	jmp    80105712 <alltraps>
...
80105c02:	6a 03                	push   $0x3
  jmp alltraps
80105c04:	e9 09 fb ff ff       	jmp    80105712 <alltraps>
...
80105c0b:	6a 04                	push   $0x4
  jmp alltraps
80105c0d:	e9 00 fb ff ff       	jmp    80105712 <alltraps>
...
80105c14:	6a 05                	push   $0x5
  jmp alltraps
80105c16:	e9 f7 fa ff ff       	jmp    80105712 <alltraps>
...
80105c1d:	6a 06                	push   $0x6
  jmp alltraps
80105c1f:	e9 ee fa ff ff       	jmp    80105712 <alltraps>
...
80105c26:	6a 07                	push   $0x7
  jmp alltraps
80105c28:	e9 e5 fa ff ff       	jmp    80105712 <alltraps>
...
80105c2d:	6a 08                	push   $0x8
  jmp alltraps
80105c2f:	e9 de fa ff ff       	jmp    80105712 <alltraps>
...
80105c36:	6a 09                	push   $0x9
  jmp alltraps
80105c38:	e9 d5 fa ff ff       	jmp    80105712 <alltraps>
...
80105c3d:	6a 0a                	push   $0xa
  jmp alltraps
80105c3f:	e9 ce fa ff ff       	jmp    80105712 <alltraps>
...
80105c44:	6a 0b                	push   $0xb
  jmp alltraps
80105c46:	e9 c7 fa ff ff       	jmp    80105712 <alltraps>
...
80105c4b:	6a 0c                	push   $0xc
  jmp alltraps
80105c4d:	e9 c0 fa ff ff       	jmp    80105712 <alltraps>
...
80105c52:	6a 0d                	push   $0xd
  jmp alltraps
80105c54:	e9 b9 fa ff ff       	jmp    80105712 <alltraps>
...
80105c59:	6a 0e                	push   $0xe
  jmp alltraps
80105c5b:	e9 b2 fa ff ff       	jmp    80105712 <alltraps>
...
80105c62:	6a 0f                	push   $0xf
  jmp alltraps
80105c64:	e9 a9 fa ff ff       	jmp    80105712 <alltraps>
...
80105c6b:	6a 10                	push   $0x10
  jmp alltraps
80105c6d:	e9 a0 fa ff ff       	jmp    80105712 <alltraps>
...
80105c72:	6a 11                	push   $0x11
  jmp alltraps
80105c74:	e9 99 fa ff ff       	jmp    80105712 <alltraps>
...
80105c7b:	6a 12                	push   $0x12
  jmp alltraps
80105c7d:	e9 90 fa ff ff       	jmp    80105712 <alltraps>
...
80105c84:	6a 13                	push   $0x13
  jmp alltraps
80105c86:	e9 87 fa ff ff       	jmp    80105712 <alltraps>
...
80105c8d:	6a 14                	push   $0x14
  jmp alltraps
80105c8f:	e9 7e fa ff ff       	jmp    80105712 <alltraps>
...
80105c96:	6a 15                	push   $0x15
  jmp alltraps
80105c98:	e9 75 fa ff ff       	jmp    80105712 <alltraps>
...
80105c9f:	6a 16                	push   $0x16
  jmp alltraps
80105ca1:	e9 6c fa ff ff       	jmp    80105712 <alltraps>
...
80105ca8:	6a 17                	push   $0x17
  jmp alltraps
80105caa:	e9 63 fa ff ff       	jmp    80105712 <alltraps>
...
80105cb1:	6a 18                	push   $0x18
  jmp alltraps
80105cb3:	e9 5a fa ff ff       	jmp    80105712 <alltraps>
...
80105cba:	6a 19                	push   $0x19
  jmp alltraps
80105cbc:	e9 51 fa ff ff       	jmp    80105712 <alltraps>
...
80105cc3:	6a 1a                	push   $0x1a
  jmp alltraps
80105cc5:	e9 48 fa ff ff       	jmp    80105712 <alltraps>
...
80105ccc:	6a 1b                	push   $0x1b
  jmp alltraps
80105cce:	e9 3f fa ff ff       	jmp    80105712 <alltraps>
...
80105cd5:	6a 1c                	push   $0x1c
  jmp alltraps
80105cd7:	e9 36 fa ff ff       	jmp    80105712 <alltraps>
...
80105cde:	6a 1d                	push   $0x1d
  jmp alltraps
80105ce0:	e9 2d fa ff ff       	jmp    80105712 <alltraps>
...
80105ce7:	6a 1e                	push   $0x1e
  jmp alltraps
80105ce9:	e9 24 fa ff ff       	jmp    80105712 <alltraps>
...
80105cf0:	6a 1f                	push   $0x1f
  jmp alltraps
80105cf2:	e9 1b fa ff ff       	jmp    80105712 <alltraps>
...
80105cf9:	6a 20                	push   $0x20
  jmp alltraps
80105cfb:	e9 12 fa ff ff       	jmp    80105712 <alltraps>
...
80105d02:	6a 21                	push   $0x21
  jmp alltraps
80105d04:	e9 09 fa ff ff       	jmp    80105712 <alltraps>
...
80105d0b:	6a 22                	push   $0x22
  jmp alltraps
80105d0d:	e9 00 fa ff ff       	jmp    80105712 <alltraps>
...
80105d14:	6a 23                	push   $0x23
  jmp alltraps
80105d16:	e9 f7 f9 ff ff       	jmp    80105712 <alltraps>
...
80105d1d:	6a 24                	push   $0x24
  jmp alltraps
80105d1f:	e9 ee f9 ff ff       	jmp    80105712 <alltraps>
...
80105d26:	6a 25                	push   $0x25
  jmp alltraps
80105d28:	e9 e5 f9 ff ff       	jmp    80105712 <alltraps>
...
80105d2f:	6a 26                	push   $0x26
  jmp alltraps
80105d31:	e9 dc f9 ff ff       	jmp    80105712 <alltraps>
...
80105d38:	6a 27                	push   $0x27
  jmp alltraps
80105d3a:	e9 d3 f9 ff ff       	jmp    80105712 <alltraps>
...
80105d41:	6a 28                	push   $0x28
  jmp alltraps
80105d43:	e9 ca f9 ff ff       	jmp    80105712 <alltraps>
...
80105d4a:	6a 29                	push   $0x29
  jmp alltraps
80105d4c:	e9 c1 f9 ff ff       	jmp    80105712 <alltraps>
...
80105d53:	6a 2a                	push   $0x2a
  jmp alltraps
80105d55:	e9 b8 f9 ff ff       	jmp    80105712 <alltraps>
...
80105d5c:	6a 2b                	push   $0x2b
  jmp alltraps
80105d5e:	e9 af f9 ff ff       	jmp    80105712 <alltraps>
...
80105d65:	6a 2c                	push   $0x2c
  jmp alltraps
80105d67:	e9 a6 f9 ff ff       	jmp    80105712 <alltraps>
...
80105d6e:	6a 2d                	push   $0x2d
  jmp alltraps
80105d70:	e9 9d f9 ff ff       	jmp    80105712 <alltraps>
...
80105d77:	6a 2e                	push   $0x2e
  jmp alltraps
80105d79:	e9 94 f9 ff ff       	jmp    80105712 <alltraps>
...
80105d80:	6a 2f                	push   $0x2f
  jmp alltraps
80105d82:	e9 8b f9 ff ff       	jmp    80105712 <alltraps>
...
80105d89:	6a 30                	push   $0x30
  jmp alltraps
80105d8b:	e9 82 f9 ff ff       	jmp    80105712 <alltraps>
...
80105d92:	6a 31                	push   $0x31
  jmp alltraps
80105d94:	e9 79 f9 ff ff       	jmp    80105712 <alltraps>
...
80105d9b:	6a 32                	push   $0x32
  jmp alltraps
80105d9d:	e9 70 f9 ff ff       	jmp    80105712 <alltraps>
...
80105da4:	6a 33                	push   $0x33
  jmp alltraps
80105da6:	e9 67 f9 ff ff       	jmp    80105712 <alltraps>
...
80105dad:	6a 34                	push   $0x34
  jmp alltraps
80105daf:	e9 5e f9 ff ff       	jmp    80105712 <alltraps>
...
80105db6:	6a 35                	push   $0x35
  jmp alltraps
80105db8:	e9 55 f9 ff ff       	jmp    80105712 <alltraps>
...
80105dbf:	6a 36                	push   $0x36
  jmp alltraps
80105dc1:	e9 4c f9 ff ff       	jmp    80105712 <alltraps>
...
80105dc8:	6a 37                	push   $0x37
  jmp alltraps
80105dca:	e9 43 f9 ff ff       	jmp    80105712 <alltraps>
...
80105dd1:	6a 38                	push   $0x38
  jmp alltraps
80105dd3:	e9 3a f9 ff ff       	jmp    80105712 <alltraps>
...
80105dda:	6a 39                	push   $0x39
  jmp alltraps
80105ddc:	e9 31 f9 ff ff       	jmp    80105712 <alltraps>
...
80105de3:	6a 3a                	push   $0x3a
  jmp alltraps
80105de5:	e9 28 f9 ff ff       	jmp    80105712 <alltraps>
...
80105dec:	6a 3b                	push   $0x3b
  jmp alltraps
80105dee:	e9 1f f9 ff ff       	jmp    80105712 <alltraps>
...
80105df5:	6a 3c                	push   $0x3c
  jmp alltraps
80105df7:	e9 16 f9 ff ff       	jmp    80105712 <alltraps>
...
80105dfe:	6a 3d                	push   $0x3d
  jmp alltraps
80105e00:	e9 0d f9 ff ff       	jmp    80105712 <alltraps>
...
80105e07:	6a 3e                	push   $0x3e
  jmp alltraps
80105e09:	e9 04 f9 ff ff       	jmp    80105712 <alltraps>
...
80105e10:	6a 3f                	push   $0x3f
  jmp alltraps
80105e12:	e9 fb f8 ff ff       	jmp    80105712 <alltraps>
...
80105e19:	6a 40                	push   $0x40
  jmp alltraps
80105e1b:	e9 f2 f8 ff ff       	jmp    80105712 <alltraps>
...
80105e22:	6a 41                	push   $0x41
  jmp alltraps
80105e24:	e9 e9 f8 ff ff       	jmp    80105712 <alltraps>
...
80105e2b:	6a 42                	push   $0x42
  jmp alltraps
80105e2d:	e9 e0 f8 ff ff       	jmp    80105712 <alltraps>
...
80105e34:	6a 43                	push   $0x43
  jmp alltraps
80105e36:	e9 d7 f8 ff ff       	jmp    80105712 <alltraps>
...
80105e3d:	6a 44                	push   $0x44
  jmp alltraps
80105e3f:	e9 ce f8 ff ff       	jmp    80105712 <alltraps>
...
80105e46:	6a 45                	push   $0x45
  jmp alltraps
80105e48:	e9 c5 f8 ff ff       	jmp    80105712 <alltraps>
...
80105e4f:	6a 46                	push   $0x46
  jmp alltraps
80105e51:	e9 bc f8 ff ff       	jmp    80105712 <alltraps>
...
80105e58:	6a 47                	push   $0x47
  jmp alltraps
80105e5a:	e9 b3 f8 ff ff       	jmp    80105712 <alltraps>
...
80105e61:	6a 48                	push   $0x48
  jmp alltraps
80105e63:	e9 aa f8 ff ff       	jmp    80105712 <alltraps>
...
80105e6a:	6a 49                	push   $0x49
  jmp alltraps
80105e6c:	e9 a1 f8 ff ff       	jmp    80105712 <alltraps>
...
80105e73:	6a 4a                	push   $0x4a
  jmp alltraps
80105e75:	e9 98 f8 ff ff       	jmp    80105712 <alltraps>
...
80105e7c:	6a 4b                	push   $0x4b
  jmp alltraps
80105e7e:	e9 8f f8 ff ff       	jmp    80105712 <alltraps>
...
80105e85:	6a 4c                	push   $0x4c
  jmp alltraps
80105e87:	e9 86 f8 ff ff       	jmp    80105712 <alltraps>
...
80105e8e:	6a 4d                	push   $0x4d
  jmp alltraps
80105e90:	e9 7d f8 ff ff       	jmp    80105712 <alltraps>
...
80105e97:	6a 4e                	push   $0x4e
  jmp alltraps
80105e99:	e9 74 f8 ff ff       	jmp    80105712 <alltraps>
...
80105ea0:	6a 4f                	push   $0x4f
  jmp alltraps
80105ea2:	e9 6b f8 ff ff       	jmp    80105712 <alltraps>
...
80105ea9:	6a 50                	push   $0x50
  jmp alltraps
80105eab:	e9 62 f8 ff ff       	jmp    80105712 <alltraps>
...
80105eb2:	6a 51                	push   $0x51
  jmp alltraps
80105eb4:	e9 59 f8 ff ff       	jmp    80105712 <alltraps>
...
80105ebb:	6a 52                	push   $0x52
  jmp alltraps
80105ebd:	e9 50 f8 ff ff       	jmp    80105712 <alltraps>
...
80105ec4:	6a 53                	push   $0x53
  jmp alltraps
80105ec6:	e9 47 f8 ff ff       	jmp    80105712 <alltraps>
...
80105ecd:	6a 54                	push   $0x54
  jmp alltraps
80105ecf:	e9 3e f8 ff ff       	jmp    80105712 <alltraps>
...
80105ed6:	6a 55                	push   $0x55
  jmp alltraps
80105ed8:	e9 35 f8 ff ff       	jmp    80105712 <alltraps>
...
80105edf:	6a 56                	push   $0x56
  jmp alltraps
80105ee1:	e9 2c f8 ff ff       	jmp    80105712 <alltraps>
...
80105ee8:	6a 57                	push   $0x57
  jmp alltraps
80105eea:	e9 23 f8 ff ff       	jmp    80105712 <alltraps>
...
80105ef1:	6a 58                	push   $0x58
  jmp alltraps
80105ef3:	e9 1a f8 ff ff       	jmp    80105712 <alltraps>
...
80105efa:	6a 59                	push   $0x59
  jmp alltraps
80105efc:	e9 11 f8 ff ff       	jmp    80105712 <alltraps>
...
80105f03:	6a 5a                	push   $0x5a
  jmp alltraps
80105f05:	e9 08 f8 ff ff       	jmp    80105712 <alltraps>
...
80105f0c:	6a 5b                	push   $0x5b
  jmp alltraps
80105f0e:	e9 ff f7 ff ff       	jmp    80105712 <alltraps>
...
80105f15:	6a 5c                	push   $0x5c
  jmp alltraps
80105f17:	e9 f6 f7 ff ff       	jmp    80105712 <alltraps>
...
80105f1e:	6a 5d                	push   $0x5d
  jmp alltraps
80105f20:	e9 ed f7 ff ff       	jmp    80105712 <alltraps>
...
80105f27:	6a 5e                	push   $0x5e
  jmp alltraps
80105f29:	e9 e4 f7 ff ff       	jmp    80105712 <alltraps>
...
80105f30:	6a 5f                	push   $0x5f
  jmp alltraps
80105f32:	e9 db f7 ff ff       	jmp    80105712 <alltraps>
...
80105f39:	6a 60                	push   $0x60
  jmp alltraps
80105f3b:	e9 d2 f7 ff ff       	jmp    80105712 <alltraps>
...
80105f42:	6a 61                	push   $0x61
  jmp alltraps
80105f44:	e9 c9 f7 ff ff       	jmp    80105712 <alltraps>
...
80105f4b:	6a 62                	push   $0x62
  jmp alltraps
80105f4d:	e9 c0 f7 ff ff       	jmp    80105712 <alltraps>
...
80105f54:	6a 63                	push   $0x63
  jmp alltraps
80105f56:	e9 b7 f7 ff ff       	jmp    80105712 <alltraps>
...
80105f5d:	6a 64                	push   $0x64
  jmp alltraps
80105f5f:	e9 ae f7 ff ff       	jmp    80105712 <alltraps>
...
80105f66:	6a 65                	push   $0x65
  jmp alltraps
80105f68:	e9 a5 f7 ff ff       	jmp    80105712 <alltraps>
...
80105f6f:	6a 66                	push   $0x66
  jmp alltraps
80105f71:	e9 9c f7 ff ff       	jmp    80105712 <alltraps>
...
80105f78:	6a 67                	push   $0x67
  jmp alltraps
80105f7a:	e9 93 f7 ff ff       	jmp    80105712 <alltraps>
...
80105f81:	6a 68                	push   $0x68
  jmp alltraps
80105f83:	e9 8a f7 ff ff       	jmp    80105712 <alltraps>
...
80105f8a:	6a 69                	push   $0x69
  jmp alltraps
80105f8c:	e9 81 f7 ff ff       	jmp    80105712 <alltraps>
...
80105f93:	6a 6a                	push   $0x6a
  jmp alltraps
80105f95:	e9 78 f7 ff ff       	jmp    80105712 <alltraps>
...
80105f9c:	6a 6b                	push   $0x6b
  jmp alltraps
80105f9e:	e9 6f f7 ff ff       	jmp    80105712 <alltraps>
...
80105fa5:	6a 6c                	push   $0x6c
  jmp alltraps
80105fa7:	e9 66 f7 ff ff       	jmp    80105712 <alltraps>
...
80105fae:	6a 6d                	push   $0x6d
  jmp alltraps
80105fb0:	e9 5d f7 ff ff       	jmp    80105712 <alltraps>
...
80105fb7:	6a 6e                	push   $0x6e
  jmp alltraps
80105fb9:	e9 54 f7 ff ff       	jmp    80105712 <alltraps>
...
80105fc0:	6a 6f                	push   $0x6f
  jmp alltraps
80105fc2:	e9 4b f7 ff ff       	jmp    80105712 <alltraps>
...
80105fc9:	6a 70                	push   $0x70
  jmp alltraps
80105fcb:	e9 42 f7 ff ff       	jmp    80105712 <alltraps>
...
80105fd2:	6a 71                	push   $0x71
  jmp alltraps
80105fd4:	e9 39 f7 ff ff       	jmp    80105712 <alltraps>
...
80105fdb:	6a 72                	push   $0x72
  jmp alltraps
80105fdd:	e9 30 f7 ff ff       	jmp    80105712 <alltraps>
...
80105fe4:	6a 73                	push   $0x73
  jmp alltraps
80105fe6:	e9 27 f7 ff ff       	jmp    80105712 <alltraps>
...
80105fed:	6a 74                	push   $0x74
  jmp alltraps
80105fef:	e9 1e f7 ff ff       	jmp    80105712 <alltraps>
...
80105ff6:	6a 75                	push   $0x75
  jmp alltraps
80105ff8:	e9 15 f7 ff ff       	jmp    80105712 <alltraps>
...
80105fff:	6a 76                	push   $0x76
  jmp alltraps
80106001:	e9 0c f7 ff ff       	jmp    80105712 <alltraps>
...
80106008:	6a 77                	push   $0x77
  jmp alltraps
8010600a:	e9 03 f7 ff ff       	jmp    80105712 <alltraps>
...
80106011:	6a 78                	push   $0x78
  jmp alltraps
80106013:	e9 fa f6 ff ff       	jmp    80105712 <alltraps>
...
8010601a:	6a 79                	push   $0x79
  jmp alltraps
8010601c:	e9 f1 f6 ff ff       	jmp    80105712 <alltraps>
...
80106023:	6a 7a                	push   $0x7a
  jmp alltraps
80106025:	e9 e8 f6 ff ff       	jmp    80105712 <alltraps>
...
8010602c:	6a 7b                	push   $0x7b
  jmp alltraps
8010602e:	e9 df f6 ff ff       	jmp    80105712 <alltraps>
...
80106035:	6a 7c                	push   $0x7c
  jmp alltraps
80106037:	e9 d6 f6 ff ff       	jmp    80105712 <alltraps>
...
8010603e:	6a 7d                	push   $0x7d
  jmp alltraps
80106040:	e9 cd f6 ff ff       	jmp    80105712 <alltraps>
...
80106047:	6a 7e                	push   $0x7e
  jmp alltraps
80106049:	e9 c4 f6 ff ff       	jmp    80105712 <alltraps>
...
80106050:	6a 7f                	push   $0x7f
  jmp alltraps
80106052:	e9 bb f6 ff ff       	jmp    80105712 <alltraps>
...
80106059:	68 80 00 00 00       	push   $0x80
  jmp alltraps
8010605e:	e9 af f6 ff ff       	jmp    80105712 <alltraps>
...
80106065:	68 81 00 00 00       	push   $0x81
  jmp alltraps
8010606a:	e9 a3 f6 ff ff       	jmp    80105712 <alltraps>
...
80106071:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80106076:	e9 97 f6 ff ff       	jmp    80105712 <alltraps>
...
8010607d:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106082:	e9 8b f6 ff ff       	jmp    80105712 <alltraps>
...
80106089:	68 84 00 00 00       	push   $0x84
  jmp alltraps
8010608e:	e9 7f f6 ff ff       	jmp    80105712 <alltraps>
...
80106095:	68 85 00 00 00       	push   $0x85
  jmp alltraps
8010609a:	e9 73 f6 ff ff       	jmp    80105712 <alltraps>
...
801060a1:	68 86 00 00 00       	push   $0x86
  jmp alltraps
801060a6:	e9 67 f6 ff ff       	jmp    80105712 <alltraps>
...
801060ad:	68 87 00 00 00       	push   $0x87
  jmp alltraps
801060b2:	e9 5b f6 ff ff       	jmp    80105712 <alltraps>
...
801060b9:	68 88 00 00 00       	push   $0x88
  jmp alltraps
801060be:	e9 4f f6 ff ff       	jmp    80105712 <alltraps>
...
801060c5:	68 89 00 00 00       	push   $0x89
  jmp alltraps
801060ca:	e9 43 f6 ff ff       	jmp    80105712 <alltraps>
...
801060d1:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
801060d6:	e9 37 f6 ff ff       	jmp    80105712 <alltraps>
...
801060dd:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
801060e2:	e9 2b f6 ff ff       	jmp    80105712 <alltraps>
...
801060e9:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
801060ee:	e9 1f f6 ff ff       	jmp    80105712 <alltraps>
...
801060f5:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
801060fa:	e9 13 f6 ff ff       	jmp    80105712 <alltraps>
...
80106101:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80106106:	e9 07 f6 ff ff       	jmp    80105712 <alltraps>
...
8010610d:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80106112:	e9 fb f5 ff ff       	jmp    80105712 <alltraps>
...
80106119:	68 90 00 00 00       	push   $0x90
  jmp alltraps
8010611e:	e9 ef f5 ff ff       	jmp    80105712 <alltraps>
...
80106125:	68 91 00 00 00       	push   $0x91
  jmp alltraps
8010612a:	e9 e3 f5 ff ff       	jmp    80105712 <alltraps>
...
80106131:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80106136:	e9 d7 f5 ff ff       	jmp    80105712 <alltraps>
...
8010613d:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80106142:	e9 cb f5 ff ff       	jmp    80105712 <alltraps>
...
80106149:	68 94 00 00 00       	push   $0x94
  jmp alltraps
8010614e:	e9 bf f5 ff ff       	jmp    80105712 <alltraps>
...
80106155:	68 95 00 00 00       	push   $0x95
  jmp alltraps
8010615a:	e9 b3 f5 ff ff       	jmp    80105712 <alltraps>
...
80106161:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80106166:	e9 a7 f5 ff ff       	jmp    80105712 <alltraps>
...
8010616d:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80106172:	e9 9b f5 ff ff       	jmp    80105712 <alltraps>
...
80106179:	68 98 00 00 00       	push   $0x98
  jmp alltraps
8010617e:	e9 8f f5 ff ff       	jmp    80105712 <alltraps>
...
80106185:	68 99 00 00 00       	push   $0x99
  jmp alltraps
8010618a:	e9 83 f5 ff ff       	jmp    80105712 <alltraps>
...
80106191:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80106196:	e9 77 f5 ff ff       	jmp    80105712 <alltraps>
...
8010619d:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
801061a2:	e9 6b f5 ff ff       	jmp    80105712 <alltraps>
...
801061a9:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
801061ae:	e9 5f f5 ff ff       	jmp    80105712 <alltraps>
...
801061b5:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
801061ba:	e9 53 f5 ff ff       	jmp    80105712 <alltraps>
...
801061c1:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
801061c6:	e9 47 f5 ff ff       	jmp    80105712 <alltraps>
...
801061cd:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
801061d2:	e9 3b f5 ff ff       	jmp    80105712 <alltraps>
...
801061d9:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
801061de:	e9 2f f5 ff ff       	jmp    80105712 <alltraps>
...
801061e5:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
801061ea:	e9 23 f5 ff ff       	jmp    80105712 <alltraps>
...
801061f1:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
801061f6:	e9 17 f5 ff ff       	jmp    80105712 <alltraps>
...
801061fd:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80106202:	e9 0b f5 ff ff       	jmp    80105712 <alltraps>
...
80106209:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
8010620e:	e9 ff f4 ff ff       	jmp    80105712 <alltraps>
...
80106215:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
8010621a:	e9 f3 f4 ff ff       	jmp    80105712 <alltraps>
...
80106221:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80106226:	e9 e7 f4 ff ff       	jmp    80105712 <alltraps>
...
8010622d:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80106232:	e9 db f4 ff ff       	jmp    80105712 <alltraps>
...
80106239:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
8010623e:	e9 cf f4 ff ff       	jmp    80105712 <alltraps>
...
80106245:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
8010624a:	e9 c3 f4 ff ff       	jmp    80105712 <alltraps>
...
80106251:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80106256:	e9 b7 f4 ff ff       	jmp    80105712 <alltraps>
...
8010625d:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80106262:	e9 ab f4 ff ff       	jmp    80105712 <alltraps>
...
80106269:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
8010626e:	e9 9f f4 ff ff       	jmp    80105712 <alltraps>
...
80106275:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
8010627a:	e9 93 f4 ff ff       	jmp    80105712 <alltraps>
...
80106281:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80106286:	e9 87 f4 ff ff       	jmp    80105712 <alltraps>
...
8010628d:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106292:	e9 7b f4 ff ff       	jmp    80105712 <alltraps>
...
80106299:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
8010629e:	e9 6f f4 ff ff       	jmp    80105712 <alltraps>
...
801062a5:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
801062aa:	e9 63 f4 ff ff       	jmp    80105712 <alltraps>
...
801062b1:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
801062b6:	e9 57 f4 ff ff       	jmp    80105712 <alltraps>
...
801062bd:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
801062c2:	e9 4b f4 ff ff       	jmp    80105712 <alltraps>
...
801062c9:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
801062ce:	e9 3f f4 ff ff       	jmp    80105712 <alltraps>
...
801062d5:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
801062da:	e9 33 f4 ff ff       	jmp    80105712 <alltraps>
...
801062e1:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
801062e6:	e9 27 f4 ff ff       	jmp    80105712 <alltraps>
...
801062ed:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
801062f2:	e9 1b f4 ff ff       	jmp    80105712 <alltraps>
...
801062f9:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
801062fe:	e9 0f f4 ff ff       	jmp    80105712 <alltraps>
...
80106305:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
8010630a:	e9 03 f4 ff ff       	jmp    80105712 <alltraps>
...
80106311:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80106316:	e9 f7 f3 ff ff       	jmp    80105712 <alltraps>
...
8010631d:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80106322:	e9 eb f3 ff ff       	jmp    80105712 <alltraps>
...
80106329:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
8010632e:	e9 df f3 ff ff       	jmp    80105712 <alltraps>
...
80106335:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
8010633a:	e9 d3 f3 ff ff       	jmp    80105712 <alltraps>
...
80106341:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80106346:	e9 c7 f3 ff ff       	jmp    80105712 <alltraps>
...
8010634d:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80106352:	e9 bb f3 ff ff       	jmp    80105712 <alltraps>
...
80106359:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
8010635e:	e9 af f3 ff ff       	jmp    80105712 <alltraps>
...
80106365:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
8010636a:	e9 a3 f3 ff ff       	jmp    80105712 <alltraps>
...
80106371:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80106376:	e9 97 f3 ff ff       	jmp    80105712 <alltraps>
...
8010637d:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106382:	e9 8b f3 ff ff       	jmp    80105712 <alltraps>
...
80106389:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
8010638e:	e9 7f f3 ff ff       	jmp    80105712 <alltraps>
...
80106395:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
8010639a:	e9 73 f3 ff ff       	jmp    80105712 <alltraps>
...
801063a1:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
801063a6:	e9 67 f3 ff ff       	jmp    80105712 <alltraps>
...
801063ad:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
801063b2:	e9 5b f3 ff ff       	jmp    80105712 <alltraps>
...
801063b9:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
801063be:	e9 4f f3 ff ff       	jmp    80105712 <alltraps>
...
801063c5:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
801063ca:	e9 43 f3 ff ff       	jmp    80105712 <alltraps>
...
801063d1:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
801063d6:	e9 37 f3 ff ff       	jmp    80105712 <alltraps>
...
801063dd:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
801063e2:	e9 2b f3 ff ff       	jmp    80105712 <alltraps>
...
801063e9:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
801063ee:	e9 1f f3 ff ff       	jmp    80105712 <alltraps>
...
801063f5:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
801063fa:	e9 13 f3 ff ff       	jmp    80105712 <alltraps>
...
80106401:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80106406:	e9 07 f3 ff ff       	jmp    80105712 <alltraps>
...
8010640d:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80106412:	e9 fb f2 ff ff       	jmp    80105712 <alltraps>
...
80106419:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
8010641e:	e9 ef f2 ff ff       	jmp    80105712 <alltraps>
...
80106425:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
8010642a:	e9 e3 f2 ff ff       	jmp    80105712 <alltraps>
...
80106431:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80106436:	e9 d7 f2 ff ff       	jmp    80105712 <alltraps>
...
8010643d:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80106442:	e9 cb f2 ff ff       	jmp    80105712 <alltraps>
...
80106449:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
8010644e:	e9 bf f2 ff ff       	jmp    80105712 <alltraps>
...
80106455:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
8010645a:	e9 b3 f2 ff ff       	jmp    80105712 <alltraps>
...
80106461:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80106466:	e9 a7 f2 ff ff       	jmp    80105712 <alltraps>
...
8010646d:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106472:	e9 9b f2 ff ff       	jmp    80105712 <alltraps>
...
80106479:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
8010647e:	e9 8f f2 ff ff       	jmp    80105712 <alltraps>
...
80106485:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
8010648a:	e9 83 f2 ff ff       	jmp    80105712 <alltraps>
...
80106491:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106496:	e9 77 f2 ff ff       	jmp    80105712 <alltraps>
...
8010649d:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
801064a2:	e9 6b f2 ff ff       	jmp    80105712 <alltraps>
...
801064a9:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
801064ae:	e9 5f f2 ff ff       	jmp    80105712 <alltraps>
...
801064b5:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
801064ba:	e9 53 f2 ff ff       	jmp    80105712 <alltraps>
...
801064c1:	68 de 00 00 00       	push   $0xde
  jmp alltraps
801064c6:	e9 47 f2 ff ff       	jmp    80105712 <alltraps>
...
801064cd:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
801064d2:	e9 3b f2 ff ff       	jmp    80105712 <alltraps>
...
801064d9:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
801064de:	e9 2f f2 ff ff       	jmp    80105712 <alltraps>
...
801064e5:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
801064ea:	e9 23 f2 ff ff       	jmp    80105712 <alltraps>
...
801064f1:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
801064f6:	e9 17 f2 ff ff       	jmp    80105712 <alltraps>
...
801064fd:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80106502:	e9 0b f2 ff ff       	jmp    80105712 <alltraps>
...
80106509:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
8010650e:	e9 ff f1 ff ff       	jmp    80105712 <alltraps>
...
80106515:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
8010651a:	e9 f3 f1 ff ff       	jmp    80105712 <alltraps>
...
80106521:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80106526:	e9 e7 f1 ff ff       	jmp    80105712 <alltraps>
...
8010652d:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80106532:	e9 db f1 ff ff       	jmp    80105712 <alltraps>
...
80106539:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
8010653e:	e9 cf f1 ff ff       	jmp    80105712 <alltraps>
...
80106545:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
8010654a:	e9 c3 f1 ff ff       	jmp    80105712 <alltraps>
...
80106551:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80106556:	e9 b7 f1 ff ff       	jmp    80105712 <alltraps>
...
8010655d:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106562:	e9 ab f1 ff ff       	jmp    80105712 <alltraps>
...
80106569:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
8010656e:	e9 9f f1 ff ff       	jmp    80105712 <alltraps>
...
80106575:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
8010657a:	e9 93 f1 ff ff       	jmp    80105712 <alltraps>
...
80106581:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80106586:	e9 87 f1 ff ff       	jmp    80105712 <alltraps>
...
8010658d:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106592:	e9 7b f1 ff ff       	jmp    80105712 <alltraps>
...
80106599:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
8010659e:	e9 6f f1 ff ff       	jmp    80105712 <alltraps>
...
801065a5:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
801065aa:	e9 63 f1 ff ff       	jmp    80105712 <alltraps>
...
801065b1:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
801065b6:	e9 57 f1 ff ff       	jmp    80105712 <alltraps>
...
801065bd:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
801065c2:	e9 4b f1 ff ff       	jmp    80105712 <alltraps>
...
801065c9:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
801065ce:	e9 3f f1 ff ff       	jmp    80105712 <alltraps>
...
801065d5:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
801065da:	e9 33 f1 ff ff       	jmp    80105712 <alltraps>
...
801065e1:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
801065e6:	e9 27 f1 ff ff       	jmp    80105712 <alltraps>
...
801065ed:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
801065f2:	e9 1b f1 ff ff       	jmp    80105712 <alltraps>
...
801065f9:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
801065fe:	e9 0f f1 ff ff       	jmp    80105712 <alltraps>
...
80106605:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
8010660a:	e9 03 f1 ff ff       	jmp    80105712 <alltraps>
...
80106611:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80106616:	e9 f7 f0 ff ff       	jmp    80105712 <alltraps>
...
8010661d:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106622:	e9 eb f0 ff ff       	jmp    80105712 <alltraps>
...
80106629:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
8010662e:	e9 df f0 ff ff       	jmp    80105712 <alltraps>
...
80106635:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
8010663a:	e9 d3 f0 ff ff       	jmp    80105712 <alltraps>
...
80106641:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106646:	e9 c7 f0 ff ff       	jmp    80105712 <alltraps>
...
8010664d:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106652:	e9 bb f0 ff ff       	jmp    80105712 <alltraps>
...
8010675d:	68 54 7b 10 80       	push   $0x80107b54
...
8010677c:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
deallocuvm(pde_t *pgdir, uint oldsz, uint newsz)
80106782:	83 ec 1c             	sub    $0x1c,%esp
80106785:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  for(; a  < oldsz; a += PGSIZE){
80106788:	39 d3                	cmp    %edx,%ebx
deallocuvm(pde_t *pgdir, uint oldsz, uint newsz)
8010678a:	89 4d d8             	mov    %ecx,-0x28(%ebp)
  for(; a  < oldsz; a += PGSIZE){
8010678d:	0f 83 ab 00 00 00    	jae    8010683e <deallocuvm.part.0+0xce>
80106793:	89 55 e0             	mov    %edx,-0x20(%ebp)
80106796:	eb 79                	jmp    80106811 <deallocuvm.part.0+0xa1>
80106798:	90                   	nop
...
801067a5:	74 5f                	je     80106806 <deallocuvm.part.0+0x96>
      pa = PTE_ADDR(*pte);
      if(pa == 0)
801067a7:	89 d7                	mov    %edx,%edi
801067a9:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
801067af:	0f 84 b6 00 00 00    	je     8010686b <deallocuvm.part.0+0xfb>
        panic("kfree");
      char *v = P2V(pa);
...
801067b8:	89 55 dc             	mov    %edx,-0x24(%ebp)
801067bb:	68 c0 54 11 80       	push   $0x801154c0
801067c0:	e8 4b dc ff ff       	call   80104410 <acquire>
801067c5:	8b 55 dc             	mov    -0x24(%ebp),%edx
      if(counter[pa/PGSIZE == 1]){
801067c8:	8d 8f 00 f0 ff ff    	lea    -0x1000(%edi),%ecx
801067ce:	83 c4 10             	add    $0x10,%esp
801067d1:	c1 ea 0c             	shr    $0xc,%edx
801067d4:	81 f9 ff 0f 00 00    	cmp    $0xfff,%ecx
801067da:	0f 96 c1             	setbe  %cl
801067dd:	0f b6 c9             	movzbl %cl,%ecx
801067e0:	80 b9 00 55 11 80 00 	cmpb   $0x0,-0x7feeab00(%ecx)
801067e7:	75 67                	jne    80106850 <deallocuvm.part.0+0xe0>
        counter[pa/PGSIZE] -=1;
        kfree(v);
      }
      else{
        counter[pa/PGSIZE] -=1;
801067e9:	80 aa 00 55 11 80 01 	subb   $0x1,-0x7feeab00(%edx)
      }
      release(&lock);
801067f0:	83 ec 0c             	sub    $0xc,%esp
801067f3:	68 c0 54 11 80       	push   $0x801154c0
801067f8:	e8 d3 dc ff ff       	call   801044d0 <release>
      *pte = 0;
801067fd:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
80106803:	83 c4 10             	add    $0x10,%esp
  for(; a  < oldsz; a += PGSIZE){
80106806:	81 c3 00 10 00 00    	add    $0x1000,%ebx
8010680c:	3b 5d e0             	cmp    -0x20(%ebp),%ebx
8010680f:	73 2d                	jae    8010683e <deallocuvm.part.0+0xce>
    pte = walkpgdir(pgdir, (char*)a, 0);
80106811:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106814:	31 c9                	xor    %ecx,%ecx
80106816:	89 da                	mov    %ebx,%edx
80106818:	e8 43 fe ff ff       	call   80106660 <walkpgdir>
    if(!pte)
8010681d:	85 c0                	test   %eax,%eax
    pte = walkpgdir(pgdir, (char*)a, 0);
8010681f:	89 c6                	mov    %eax,%esi
    if(!pte)
80106821:	0f 85 79 ff ff ff    	jne    801067a0 <deallocuvm.part.0+0x30>
      a = PGADDR(PDX(a) + 1, 0, 0) - PGSIZE;
80106827:	81 e3 00 00 c0 ff    	and    $0xffc00000,%ebx
8010682d:	81 c3 00 f0 3f 00    	add    $0x3ff000,%ebx
  for(; a  < oldsz; a += PGSIZE){
80106833:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80106839:	3b 5d e0             	cmp    -0x20(%ebp),%ebx
8010683c:	72 d3                	jb     80106811 <deallocuvm.part.0+0xa1>
    }
  }
  return newsz;
}
8010683e:	8b 45 d8             	mov    -0x28(%ebp),%eax
...
80106850:	83 ec 0c             	sub    $0xc,%esp
      char *v = P2V(pa);
80106853:	81 c7 00 00 00 80    	add    $0x80000000,%edi
        counter[pa/PGSIZE] -=1;
80106859:	80 aa 00 55 11 80 01 	subb   $0x1,-0x7feeab00(%edx)
        kfree(v);
80106860:	57                   	push   %edi
80106861:	e8 aa ba ff ff       	call   80102310 <kfree>
80106866:	83 c4 10             	add    $0x10,%esp
80106869:	eb 85                	jmp    801067f0 <deallocuvm.part.0+0x80>
        panic("kfree");
8010686b:	83 ec 0c             	sub    $0xc,%esp
8010686e:	68 a6 74 10 80       	push   $0x801074a6
80106873:	e8 18 9b ff ff       	call   80100390 <panic>
80106878:	90                   	nop
...
80106910:	a1 f4 54 11 80       	mov    0x801154f4,%eax
{
...
80106a09:	5d                   	pop    %ebp
  popcli();
80106a0a:	e9 71 d9 ff ff       	jmp    80104380 <popcli>
...
80106a78:	e8 a3 da ff ff       	call   80104520 <memset>
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
80106a7d:	58                   	pop    %eax
80106a7e:	5a                   	pop    %edx
...
80106a8a:	31 d2                	xor    %edx,%edx
  counter[V2P(mem)/PGSIZE] +=1;
80106a8c:	c1 eb 0c             	shr    $0xc,%ebx
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
80106a8f:	e8 4c fc ff ff       	call   801066e0 <mappages>
  memmove(mem, init, sz);
80106a94:	83 c4 0c             	add    $0xc,%esp
80106a97:	57                   	push   %edi
80106a98:	ff 75 e0             	pushl  -0x20(%ebp)
80106a9b:	56                   	push   %esi
80106a9c:	e8 2f db ff ff       	call   801045d0 <memmove>
  acquire(&lock);
80106aa1:	c7 04 24 c0 54 11 80 	movl   $0x801154c0,(%esp)
80106aa8:	e8 63 d9 ff ff       	call   80104410 <acquire>
  counter[V2P(mem)/PGSIZE] +=1;
80106aad:	80 83 00 55 11 80 01 	addb   $0x1,-0x7feeab00(%ebx)
  release(&lock);
80106ab4:	c7 45 08 c0 54 11 80 	movl   $0x801154c0,0x8(%ebp)
...
80106ac4:	5d                   	pop    %ebp
  release(&lock);
80106ac5:	e9 06 da ff ff       	jmp    801044d0 <release>
    panic("inituvm: more than a page");
80106aca:	83 ec 0c             	sub    $0xc,%esp
80106acd:	68 99 7b 10 80       	push   $0x80107b99
...
80106b23:	e8 38 fb ff ff       	call   80106660 <walkpgdir>
...
80106bf1:	e8 2a d9 ff ff       	call   80104520 <memset>
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
80106bf6:	58                   	pop    %eax
80106bf7:	5a                   	pop    %edx
...
80106c05:	e8 d6 fa ff ff       	call   801066e0 <mappages>
...
80106c17:	81 c6 00 10 00 00    	add    $0x1000,%esi
    acquire(&lock);
80106c1d:	68 c0 54 11 80       	push   $0x801154c0
80106c22:	e8 e9 d7 ff ff       	call   80104410 <acquire>
    counter[V2P(mem)/PGSIZE] +=1;
80106c27:	80 83 00 55 11 80 01 	addb   $0x1,-0x7feeab00(%ebx)
    release(&lock);
80106c2e:	c7 04 24 c0 54 11 80 	movl   $0x801154c0,(%esp)
80106c35:	e8 96 d8 ff ff       	call   801044d0 <release>
  for(; a < newsz; a += PGSIZE){
...
80106c50:	68 d1 7b 10 80       	push   $0x80107bd1
...
80106c93:	68 e9 7b 10 80       	push   $0x80107be9
...
80106cb0:	e8 bb fa ff ff       	call   80106770 <deallocuvm.part.0>
      kfree(mem);
...
80106ce0:	e8 8b fa ff ff       	call   80106770 <deallocuvm.part.0>
      return 0;
...
80106d8c:	68 05 7c 10 80       	push   $0x80107c05
...
80106dc0:	e8 5b d7 ff ff       	call   80104520 <memset>
...
80106ddb:	e8 00 f9 ff ff       	call   801066e0 <mappages>
...
80106e2b:	a3 f4 54 11 80       	mov    %eax,0x801154f4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
80106e4e:	e8 0d f8 ff ff       	call   80106660 <walkpgdir>
  if(pte == 0)
...
80106e5f:	68 16 7c 10 80       	push   $0x80107c16
...
80106eb0:	e8 1b d7 ff ff       	call   801045d0 <memmove>
...
80106ecb:	e8 10 f8 ff ff       	call   801066e0 <mappages>
...
80106ee9:	e8 72 f7 ff ff       	call   80106660 <walkpgdir>
...
80106f66:	83 ec 0c             	sub    $0xc,%esp
  ...
  if((d = setupkvm()) == 0)
80106f69:	e8 32 fe ff ff       	call   80106da0 <setupkvm>
80106f6e:	85 c0                	test   %eax,%eax
80106f70:	89 c7                	mov    %eax,%edi
80106f72:	0f 84 a3 00 00 00    	je     8010701b <cow+0xbb>
    return 0;
    
  for(i = 0; i < sz; i += PGSIZE){
80106f78:	8b 45 0c             	mov    0xc(%ebp),%eax
80106f7b:	85 c0                	test   %eax,%eax
80106f7d:	0f 84 a5 00 00 00    	je     80107028 <cow+0xc8>
80106f83:	31 f6                	xor    %esi,%esi
80106f85:	eb 3a                	jmp    80106fc1 <cow+0x61>
80106f87:	89 f6                	mov    %esi,%esi
80106f89:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
    *pte &= ~PTE_W; //write only
    flags = PTE_FLAGS(*pte);
...
80106f90:	83 ec 0c             	sub    $0xc,%esp
    counter[pa/PGSIZE]+= 1;
80106f93:	c1 eb 0c             	shr    $0xc,%ebx
  for(i = 0; i < sz; i += PGSIZE){
80106f96:	81 c6 00 10 00 00    	add    $0x1000,%esi
    acquire(&lock);
80106f9c:	68 c0 54 11 80       	push   $0x801154c0
80106fa1:	e8 6a d4 ff ff       	call   80104410 <acquire>
    counter[pa/PGSIZE]+= 1;
80106fa6:	80 83 00 55 11 80 01 	addb   $0x1,-0x7feeab00(%ebx)
    release(&lock);
80106fad:	c7 04 24 c0 54 11 80 	movl   $0x801154c0,(%esp)
80106fb4:	e8 17 d5 ff ff       	call   801044d0 <release>
  for(i = 0; i < sz; i += PGSIZE){
80106fb9:	83 c4 10             	add    $0x10,%esp
80106fbc:	39 75 0c             	cmp    %esi,0xc(%ebp)
80106fbf:	76 67                	jbe    80107028 <cow+0xc8>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
80106fc1:	8b 45 08             	mov    0x8(%ebp),%eax
80106fc4:	31 c9                	xor    %ecx,%ecx
80106fc6:	89 f2                	mov    %esi,%edx
80106fc8:	e8 93 f6 ff ff       	call   80106660 <walkpgdir>
80106fcd:	85 c0                	test   %eax,%eax
80106fcf:	74 79                	je     8010704a <cow+0xea>
    if(!(*pte & PTE_P))
80106fd1:	8b 18                	mov    (%eax),%ebx
80106fd3:	f6 c3 01             	test   $0x1,%bl
80106fd6:	74 65                	je     8010703d <cow+0xdd>
    *pte &= ~PTE_W; //write only
80106fd8:	89 da                	mov    %ebx,%edx
    if(mappages(d, (void*)i, PGSIZE, pa, flags) < 0) {
80106fda:	83 ec 08             	sub    $0x8,%esp
80106fdd:	b9 00 10 00 00       	mov    $0x1000,%ecx
    *pte &= ~PTE_W; //write only
80106fe2:	83 e2 fd             	and    $0xfffffffd,%edx
80106fe5:	80 ce 02             	or     $0x2,%dh
80106fe8:	89 10                	mov    %edx,(%eax)
    flags = PTE_FLAGS(*pte);
80106fea:	89 d8                	mov    %ebx,%eax
    if(mappages(d, (void*)i, PGSIZE, pa, flags) < 0) {
80106fec:	89 f2                	mov    %esi,%edx
    flags = PTE_FLAGS(*pte);
80106fee:	25 fd 0f 00 00       	and    $0xffd,%eax
80106ff3:	80 cc 02             	or     $0x2,%ah
    if(mappages(d, (void*)i, PGSIZE, pa, flags) < 0) {
80106ff6:	50                   	push   %eax
    pa = PTE_ADDR(*pte);
80106ff7:	89 d8                	mov    %ebx,%eax
80106ff9:	25 00 f0 ff ff       	and    $0xfffff000,%eax
    if(mappages(d, (void*)i, PGSIZE, pa, flags) < 0) {
80106ffe:	50                   	push   %eax
80106fff:	89 f8                	mov    %edi,%eax
80107001:	e8 da f6 ff ff       	call   801066e0 <mappages>
80107006:	83 c4 10             	add    $0x10,%esp
80107009:	85 c0                	test   %eax,%eax
8010700b:	79 83                	jns    80106f90 <cow+0x30>
  }
  lcr3(V2P(pgdir));
  return d;
...
80107010:	57                   	push   %edi
  return 0;
80107011:	31 ff                	xor    %edi,%edi
  freevm(d);
80107013:	e8 08 fd ff ff       	call   80106d20 <freevm>
  return 0;
80107018:	83 c4 10             	add    $0x10,%esp
}
8010701b:	8d 65 f4             	lea    -0xc(%ebp),%esp
8010701e:	89 f8                	mov    %edi,%eax
80107020:	5b                   	pop    %ebx
80107021:	5e                   	pop    %esi
80107022:	5f                   	pop    %edi
80107023:	5d                   	pop    %ebp
...
8010706e:	e8 ed f5 ff ff       	call   80106660 <walkpgdir>
  if((*pte & PTE_P) == 0)
...
801070df:	e8 ec d4 ff ff       	call   801045d0 <memmove>
    len -= n;
    buf += n;
...
8010714e:	0f 84 dd 00 00 00    	je     80107231 <pagefault+0xf1>
    panic("cr2 addres is 0");
  }
...
80107160:	e8 fb f4 ff ff       	call   80106660 <walkpgdir>
  if(pte == 0){
80107165:	85 c0                	test   %eax,%eax
  pte_t* pte = walkpgdir(myproc()->pgdir, (void*) va, 0);
80107167:	89 c7                	mov    %eax,%edi
  if(pte == 0){
80107169:	0f 84 b5 00 00 00    	je     80107224 <pagefault+0xe4>
    panic("Page fault");
  }
  //4 If pte is no shared --> give panic error
  if(!(*pte & PTE_SH)){
8010716f:	8b 18                	mov    (%eax),%ebx
80107171:	f6 c7 02             	test   $0x2,%bh
80107174:	0f 84 aa 00 00 00    	je     80107224 <pagefault+0xe4>
    panic("Page fault");
  }
  //5- If pte is not present -> give panic error
  if(!(*pte & PTE_P)){
8010717a:	f6 c3 01             	test   $0x1,%bl
8010717d:	0f 84 a1 00 00 00    	je     80107224 <pagefault+0xe4>
  uint pa = PTE_ADDR(*pte);
  //7- Check if the table is shared or not

  //  8- If shared -> look next slides
  //    8.1 Create new page table
  char *new_va = kalloc();
80107183:	e8 38 b3 ff ff       	call   801024c0 <kalloc>
80107188:	89 c6                	mov    %eax,%esi
  uint pa = PTE_ADDR(*pte);
8010718a:	89 d8                	mov    %ebx,%eax
...
8010718f:	25 00 f0 ff ff       	and    $0xfffff000,%eax
  memmove(new_va, (char*)P2V(pa), PGSIZE);
80107194:	68 00 10 00 00       	push   $0x1000
  acquire(&lock);
  *pte = (new_pa) | (PTE_P) | (PTE_W) | (PTE_U);
  //    8.4 insert the new physical page num
  counter[new_pa/PGSIZE] = 1;
  //    8.5 decrease the counter
  counter[pa/PGSIZE] -=1;
80107199:	c1 eb 0c             	shr    $0xc,%ebx
  memmove(new_va, (char*)P2V(pa), PGSIZE);
8010719c:	05 00 00 00 80       	add    $0x80000000,%eax
801071a1:	50                   	push   %eax
801071a2:	56                   	push   %esi
  uint new_pa = V2P(new_va);
801071a3:	81 c6 00 00 00 80    	add    $0x80000000,%esi
  memmove(new_va, (char*)P2V(pa), PGSIZE);
801071a9:	e8 22 d4 ff ff       	call   801045d0 <memmove>
  acquire(&lock);
801071ae:	c7 04 24 c0 54 11 80 	movl   $0x801154c0,(%esp)
801071b5:	e8 56 d2 ff ff       	call   80104410 <acquire>
  *pte = (new_pa) | (PTE_P) | (PTE_W) | (PTE_U);
801071ba:	89 f0                	mov    %esi,%eax
  counter[new_pa/PGSIZE] = 1;
801071bc:	c1 ee 0c             	shr    $0xc,%esi
  *pte = (new_pa) | (PTE_P) | (PTE_W) | (PTE_U);
801071bf:	83 c8 07             	or     $0x7,%eax
801071c2:	89 07                	mov    %eax,(%edi)
  counter[new_pa/PGSIZE] = 1;
801071c4:	c6 86 00 55 11 80 01 	movb   $0x1,-0x7feeab00(%esi)
  release(&lock);
801071cb:	c7 04 24 c0 54 11 80 	movl   $0x801154c0,(%esp)
  counter[pa/PGSIZE] -=1;
801071d2:	80 ab 00 55 11 80 01 	subb   $0x1,-0x7feeab00(%ebx)
  release(&lock);
801071d9:	e8 f2 d2 ff ff       	call   801044d0 <release>
  //  9- If not shared -> make table writable and not shared using flags
    if((counter[pa/PGSIZE] <= 1)){
    if(counter[pa/PGSIZE] == 1){
801071de:	83 c4 10             	add    $0x10,%esp
801071e1:	80 bb 00 55 11 80 01 	cmpb   $0x1,-0x7feeab00(%ebx)
801071e8:	74 1e                	je     80107208 <pagefault+0xc8>
  ...
  lcr3(V2P(myproc()->pgdir));
801071ea:	e8 f1 c5 ff ff       	call   801037e0 <myproc>
801071ef:	8b 40 04             	mov    0x4(%eax),%eax
801071f2:	05 00 00 00 80       	add    $0x80000000,%eax
  asm volatile("movl %0,%%cr3" : : "r" (val));
801071f7:	0f 22 d8             	mov    %eax,%cr3
...
8010720a:	80 e4 fd             	and    $0xfd,%ah
8010720d:	83 c8 02             	or     $0x2,%eax
80107210:	89 07                	mov    %eax,(%edi)
      lcr3(V2P(myproc()->pgdir));
80107212:	e8 c9 c5 ff ff       	call   801037e0 <myproc>
80107217:	8b 40 04             	mov    0x4(%eax),%eax
8010721a:	05 00 00 00 80       	add    $0x80000000,%eax
8010721f:	0f 22 d8             	mov    %eax,%cr3
80107222:	eb d6                	jmp    801071fa <pagefault+0xba>
    panic("Page fault");
80107224:	83 ec 0c             	sub    $0xc,%esp
80107227:	68 96 7c 10 80       	push   $0x80107c96
8010722c:	e8 5f 91 ff ff       	call   80100390 <panic>
    panic("cr2 addres is 0");
80107231:	83 ec 0c             	sub    $0xc,%esp
80107234:	68 86 7c 10 80       	push   $0x80107c86
80107239:	e8 52 91 ff ff       	call   80100390 <panic>
